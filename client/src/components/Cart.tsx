                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-muted-foreground">
                        {(item.product.price / 100).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} $ / {item.product.unitType || "حبة"}
                      </p>
                    ...
                    <div className="text-left font-bold text-primary">
                      {(item.product.price * item.quantity / 100).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })} $
                    </div>
                  </div>
                ))
              )}
